...
class TranspilerSmokeTests(unittest.TestCase):
    ...
    def test_builtin_mapping_supports_nested_names_only(self) -> None:
        ...
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Sort"), "fstd.TupleSort")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Unique"), "fstd.TupleUnique")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Min"), "fstd.TupleMin")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Max"), "fstd.TupleMax")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Reduce"), "fstd.TupleReduce")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.FindIndex"), "fstd.TupleFindIndex")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Any"), "fstd.TupleAny")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.All"), "fstd.TupleAll")
        self.assertEqual(self.transpiler._builtin_expr("Std.Tuple.Range"), "fstd.TupleRange")
