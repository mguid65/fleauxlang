...
[[nodiscard]] inline auto Wrap(Value value) -> Value {
...
[[nodiscard]] inline auto Length(Value arg) -> Value {
...
[[nodiscard]] inline auto Equal(Value arg) -> Value {
  return make_bool(array_at(arg, 0) == array_at(arg, 1));
}

[[nodiscard]] inline auto NotEqual(Value arg) -> Value {
  return make_bool(array_at(arg, 0) != array_at(arg, 1));
}

[[nodiscard]] inline auto Not(Value arg) -> Value {
