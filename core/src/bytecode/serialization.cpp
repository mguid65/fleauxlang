...
// Builtin operands are serialized as numeric BuiltinId values, so changes to
// builtin ordering are bytecode ABI changes and must invalidate cached modules.
...
constexpr std::uint32_t BYTECODE_VERSION = 13;
